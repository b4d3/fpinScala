...
object MyModule {
  ...
  def fib(n: Int): Int = {
    ...
    def loop(i: Int, accLeft: Int, accRight: Int): Int = {
      if (i <= 0) accLeft
      else loop(i - 1, accRight, accLeft + accRight)
    }
...
object PolymorphicFunctions {
  ...
  def isSorted[A](as: Array[A], gt: (A, A) => Boolean): Boolean = {
    ...
    def loop(n1: Int, n2: Int): Boolean = {
      ...
      else if (gt(as(n1), as(n2))) loop(n2, n2 + 1)
      else false
    }
  ...
  def main(args: Array[String]): Unit = {
    ...
    assert(isSorted(Array(3, 2, 1), (a: Int, b: Int) => a > b), true)
    assert(!isSorted(Array(3, 2, 5), (a: Int, b: Int) => a > b))
